        ...
        <nav className="bg-card border-b border-border/50 px-4 sm:px-6 md:px-8 py-3 sm:py-4 sticky top-0 z-30 flex items-center justify-between gap-2 sm:gap-4">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="min-w-0">
              <h1 className="text-lg sm:text-xl lg:text-2xl font-bold truncate">Patients Management</h1>
              <p className="text-xs sm:text-sm text-muted-foreground line-clamp-1 hidden sm:block">Manage and view patient information</p>
            </div>
          </div>
