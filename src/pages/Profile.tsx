        ...
        <div className="p-3 sm:p-4 md:p-6 lg:p-8 mobile-content mobile-text-container">
          {isEditing ? (
            ...
            <div className="space-y-6">
              ...
              {/* AI Profile Management Section */}
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Heart className="w-5 h-5 text-red-500" />
                    Medical Profile for AI Recommendations
                  </CardTitle>
                  <CardDescription className="mobile-text-fix">
                    Complete your medical information to receive personalized AI-driven medicine recommendations
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <ProfileManagement />
